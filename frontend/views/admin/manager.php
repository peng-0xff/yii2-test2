...
?>
<a href="<?php echo Yii::$app->urlManager->createUrl('admin/add'); ?>">添加员工</a>
<form method="get">
...
<table border="1"  width="100%" align='center'>
    ...
    <tr>
        ...
        <td align='center'><button><a href="<?php echo Yii::$app->urlManager->createUrl('admin/delete',array('d'=>$r['id']));?>">删除</a></button></td>
    </tr>
    <?php endforeach; ?>
</table>